...
(function payment() {
    var d = document,
        ...
        ppForm = d.getElementsByClassName('payment__form')[0],
        ccForm = d.getElementsByClassName('payment__form')[1],
        ecForm = d.getElementsByClassName('payment__form')[2],

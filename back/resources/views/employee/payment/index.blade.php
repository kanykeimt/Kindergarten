                                            ...
                                            @if($child->payment != null)
                                                ...
                                                <td>
                                                    <div style="float: left; display: block; width: 50%;" class="text-center">
                                                        <a href="{{route('employee.payment.warning', $child->payment->id)}}"><i style="color: #ffc107" title="@lang('lang.warning')" class="fa fa-question"></i></a>
                                                    </div>
                                                    <div style="float: left; display: block; width: 50%;" class="text-center">
                                                        <a href="{{route('employee.payment.edit', $child->payment->id)}}" class="text-success"><i title="@lang('lang.add_payment')" class="fas fa-plus"></i></a>
                                                    </div>
                                                </td>
                                            @else
                                                ...
                                                <td>
                                                    ...
                                                    <div style="float: left; display: block; width: 50%;" class="text-center">
                                                        <a href="{{route('employee.payment.edit', $child->id)}}" class="text-success"><i title="@lang('lang.add_payment')" class="fas fa-plus"></i></a>
                                                    </div>
                                                </td>
                                            @endif
                                        </tr>

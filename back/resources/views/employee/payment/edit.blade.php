...
@section('content')
        ...
        <div class="col-12">
            <div id="addUserId" class="bg-light rounded h-100 p-4">
                <form action="{{route('employee.payment.create')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <a href="{{route('employee.payment.index')}}" class="btn btn-secondary">@lang('lang.back_btn')</a>

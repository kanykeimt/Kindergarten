...
@section('content')
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="container">
                <form action="{{route('employee.children.update', $child)}}" method="POST" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    ...
                    <div class="modal-footer">
                        <a href="{{route('employee.children.index')}}" class="btn btn-secondary">@lang('lang.back_btn')</a>

...
@section('content')
    <div class="col-12">
        ...
        <div class="d-none" id="addUserId" class="bg-light rounded h-100 p-4">
            <form action="{{route('employee.news.create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3" hidden="">
                    <label for="group_id" class="col-sm-3 col-form-label">@lang('lang.emp_group_name'):</label>
                    <div class="col-sm-7">
                        <input class="form-control" type="number" id="group_id" name="group_id" value="{{auth()->user()->group->id}}" required>
                    </div>
                </div>
                <div class="row mb-3">
        ...
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <form action="{{route('employee.news.delete', $date->datetime)}}" method="POST">
                        @method('DELETE')
                        @csrf
